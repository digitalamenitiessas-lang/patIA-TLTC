-- PatIA Lawn Tennis · Migración 0006
-- Corrige el bootstrap del administrador: la cuenta de Google real de Marco
-- es marco.rossi1708@gmail.com. Se usa una lista de mails admin.
...
-- Promover la cuenta ya existente de Marco
update public.player_profiles
set role = 'admin', approval_status = 'approved', updated_at = now()
where lower(email) = 'marco.rossi1708@gmail.com';
